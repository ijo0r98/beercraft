<img width="1439" alt="스크린샷 2021-08-13 오후 3 50 17" src="https://user-images.githubusercontent.com/50325009/129316568-a362898b-8468-4800-b42b-63c6e4844de0.png">
...
#### 💻 상세 기능 안내
- 모든 기능은 로그인 후 사용 가능
- 사용자 평점 위주 맥주간 코사인 유사도 기반, 가장 선호하는 맥주와 중요하게 생각하는 요인을 고려하여 맥주 추천
- 맥주경험이 없는 사용자를 위한 추천 시스템, 평가 요인의 순위를 정해 가중치를 부여하여 가장 평균 평점이 높은 맥주 추천
- 나의 과거 경험(맥주에 대한 평점)을 반영하여 새로운 맥주에 대한 평점 계산, 가장 높은 평점이 예상되는 맥주 추천
